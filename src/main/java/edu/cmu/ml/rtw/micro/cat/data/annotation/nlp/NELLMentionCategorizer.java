...
public class NELLMentionCategorizer implements AnnotatorTokenSpan<String> {
	...
	public static final File DEFAULT_FEATURES_FILE = new File("models/GSTBinaryNELLNormalized/HazyFacc1_AllNELL_c90_e100/LRBasel2.model.out");
	public static final String DEFAULT_MODEL_FILE_PATH_PREFIX = "models/GSTBinaryNELLNormalized/HazyFacc1_AllNELL_c90_e100/LRBasel2.model.out.";
