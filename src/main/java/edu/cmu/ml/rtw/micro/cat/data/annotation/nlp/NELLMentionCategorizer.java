...
public class NELLMentionCategorizer implements AnnotatorTokenSpan<String> {
	...
	public static final File DEFAULT_FEATURES_FILE = new File("resources/models/GSTBinaryNELLNormalized/AregBasel2.model.out");
	public static final String DEFAULT_MODEL_FILE_PATH_PREFIX = "resources/models/AregBasel2.model.out.";
