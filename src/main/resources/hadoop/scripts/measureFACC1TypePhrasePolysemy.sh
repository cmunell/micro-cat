...
REDUCE_TASKS=20
TIMEOUT=600000
JOB_NAME=MeasureFACC1TypePhrasePolysemy

INPUT_DIRS=[/hdfs/path/to/output/from/constructFACC1Type/]
OUTPUT_DIR=[/hdfs/path/to/output/ClueWeb09_FACC1TypePolysemy/]
